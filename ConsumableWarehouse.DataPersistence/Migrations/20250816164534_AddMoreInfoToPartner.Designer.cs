...
namespace ConsumableWarehouse.DataPersistence.Migrations
{
    ...
    [Migration("20250816164534_AddMoreInfoToPartner")]
    partial class AddMoreInfoToPartner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsumableWarehouse.Domain.Entities.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsumableWarehouse.Domain.Entities.Wishlist", b =>
                {
                    b.HasOne("ConsumableWarehouse.Domain.Entities.UserProfile", "UserProfile")
                        .WithMany("wishlists")
